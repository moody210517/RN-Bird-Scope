  ...
  renderRowTwo = ({ item }) => (
    ...
    >
      ...
      <View style={{flexDirection:"row"}}>
        ...
        <View style={{flexDirection:"row"}}>
          <VerticalText   style={{ height:200, backgroundColor:"#0f0", color: "black",fontSize: 14}} text={"23434"}/>
        </View>
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{flexDirection:"row"}}>
          <View style={{display:this.showLeftPan(this.props.tabIndex)}}>                        
            {/* <Text style={{transform: [{ rotate: '-90deg'}]}} > dfsdftett  `{this.props.tabIndex}` </Text>
            <Text style={{transform: [{ rotate: '-90deg'}]}} > dfsdftett  `{this.props.tabIndex}` </Text> */}
          </View>
